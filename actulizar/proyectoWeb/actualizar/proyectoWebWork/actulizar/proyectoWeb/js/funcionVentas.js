...
function enlistar(selectid, tableid){
  let entrada = document.getElementById(selectid
    ).value;
  ...
  document.getElementById('column' + aux+2).innerHTML= '1000';
...
function totales(table1,table2){
  
  let tabla1 = document.getElementById(table1);
  alert(tabla1.childNodes[1]);
    for (i = 0; i < tabla1.childElementCount; i++) {
      for (t = 0; t < 3; t++) {
      }
